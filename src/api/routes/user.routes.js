...
import { crearUsuarioSinPassword, crearUsuarioAdmin } from "../controllers/user.controllers.js"; /// Hola soy santiago aca importo el controlador que crea un usuario sin password
...
router.post("/", crearUsuarioAdmin); //para crear un usuario admin
